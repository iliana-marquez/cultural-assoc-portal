...
$router->get('/programm',                     'EventController', 'index');  //public-facing listing for upcomming events 
$router->get('/veranstaltungen/{slug}',       'EventController', 'show');
$router->get('/archiv/filter',                'EventController', 'archiveFilter');
$router->get('/archiv',                       'EventController', 'archive');  //public-facing listing for past events 
